...
High-throughput imitation learning for a musculoskeletal mouse forelimb model in JAX-accelerated MuJoCo.

This repo allows for the reproduction of the figures presented in: 
